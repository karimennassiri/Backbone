<?php 
    ...
    $requette=$connexion->query("SELECT * from haikuAuteurId where saison='automne' order by RAND() limit 1 "); //Requêtte pour extraire les haikus de l'été. 
