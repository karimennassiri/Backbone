<?php 
    ...
    $requette=$connexion->query("SELECT * from haikuAuteurId where saison='hiver' order by RAND() limit 1 "); //Requêtte pour extraire les haikus de l'été. 
    ...
    while($resultat = $requette->fetch()){
        ...
        $_SESSION['testhiver']= $resultat->l2;
